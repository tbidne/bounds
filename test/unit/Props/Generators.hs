...
genBounded =
  choice $
    [ pure $ MkBoundedType @All Proxy,
      ...
      pure $ MkBoundedType @CDev Proxy,
      pure $ MkBoundedType @CFsBlkCnt Proxy,
      ...
      pure $ MkBoundedType @CNfds Proxy,
      pure $ MkBoundedType @CNlink Proxy,
      pure $ MkBoundedType @COff Proxy,
      pure $ MkBoundedType @CPid Proxy,
      pure $ MkBoundedType @CRLim Proxy,
